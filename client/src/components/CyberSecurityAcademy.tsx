...
export default function CyberSecurityAcademy() {
  ...
  const courses: Course[] = [
    ...
    },
    {
      ...
      duration: 35,
      modules: 35,
      description: 'Master digital forensics techniques, evidence collection, and cyber investigation methodologies.',
      skills: ['Evidence Collection', 'Memory Analysis', 'Network Forensics', 'Mobile Forensics'],
      icon: Eye,
      color: 'green',
      progress: 8,
      completed: false,
    ...
    },
    {
      ...
      duration: 40,
      modules: 40,
      description: 'Advanced malware analysis, reverse engineering techniques, and threat attribution.',
      skills: ['Static Analysis', 'Dynamic Analysis', 'Reverse Engineering', 'Threat Attribution'],
      icon: AlertTriangle,
      color: 'red',
      progress: 0,
      completed: false,
    ...
    },
    {
      ...
      duration: 28,
      modules: 28,
      description: 'Comprehensive cloud security covering AWS, Azure, GCP with hands-on security configurations.',
      skills: ['Cloud Architecture', 'IAM Security', 'Container Security', 'DevSecOps'],
      icon: Database,
      color: 'purple',
      progress: 42,
      completed: false,
    ...
    },
    {
      ...
      duration: 22,
      modules: 22,
      description: 'Professional incident response procedures, crisis management, and post-incident analysis.',
      skills: ['Incident Handling', 'Crisis Communication', 'Recovery Planning', 'Lessons Learned'],
      icon: Target,
      color: 'orange',
      progress: 73,
      completed: false,
    ...
    },
    {
      ...
      title: 'Zero-Day Research & Vulnerability Discovery',
      category: 'ethical-hacking',
      level: 'advanced',
      duration: 45,
      modules: 45,
      description: 'Advanced vulnerability research, exploit development, and responsible disclosure practices.',
      skills: ['Vulnerability Research', 'Exploit Development', 'Fuzzing', 'Responsible Disclosure'],
      icon: Zap,
      color: 'yellow',
      progress: 12,
      completed: false,
    ...
    },
    {
      ...
      duration: 32,
      modules: 32,
      description: 'Proactive threat hunting methodologies, IOC analysis, and threat intelligence integration.',
      skills: ['Threat Hunting', 'IOC Analysis', 'SIEM Analytics', 'Threat Intelligence'],
      icon: Target,
      color: 'cyan',
      progress: 28,
      completed: false,
    ...
    },
    {
      ...
      title: 'Social Engineering & Human Psychology',
      category: 'ethical-hacking',
      level: 'intermediate',
      duration: 20,
      modules: 20,
      description: 'Understanding social engineering tactics, human psychology in security, and awareness training.',
      skills: ['Social Engineering', 'Phishing Analysis', 'Security Awareness', 'Human Factors'],
      icon: Brain,
      color: 'pink',
      progress: 55,
      completed: false,
    ...
    },
    {
      ...
      duration: 38,
      modules: 38,
      description: 'Cutting-edge quantum cryptography, post-quantum algorithms, and future-proof security.',
      skills: ['Quantum Computing', 'Post-Quantum Crypto', 'Quantum Key Distribution', 'Lattice Cryptography'],
      icon: Zap,
      color: 'violet',
      progress: 5,
      completed: false,
    ...
    {
      id: 'defi-security',
      title: 'DeFi Security & Smart Contract Auditing',
      category: 'blockchain',
      level: 'advanced',
      duration: 33,
      modules: 33,
      description: 'Specialized DeFi protocol security, yield farming risks, and automated market maker vulnerabilities.',
      skills: ['DeFi Protocols', 'AMM Security', 'Flash Loan Attacks', 'Yield Farming Risks'],
      icon: Coins,
      color: 'emerald',
      progress: 18,
      completed: false,
    ...
    },
    {
      ...
      duration: 26,
      modules: 26,
      description: 'Internet of Things security, hardware vulnerabilities, and embedded system protection.',
      skills: ['IoT Security', 'Hardware Analysis', 'Firmware Security', 'Embedded Systems'],
      icon: Network,
      color: 'teal',
      progress: 31,
      completed: false,
    ...
    },
    {
      ...
      title: 'Nation-State Threats & APT Analysis',
      category: 'cybersecurity',
      level: 'advanced',
      duration: 42,
      modules: 42,
      description: 'Advanced persistent threats, nation-state tactics, and geopolitical cyber warfare analysis.',
      skills: ['APT Analysis', 'Attribution Techniques', 'Geopolitical Cyber', 'Intelligence Analysis'],
      icon: Globe,
      color: 'red',
      progress: 7,
      completed: false,
