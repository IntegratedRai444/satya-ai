      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="timeline" className="space-y-6">
            <Card className="bg-slate-800 border-slate-700">
              <CardHeader>
                <CardTitle className="text-white">Threat Intelligence Timeline</CardTitle>
                <CardDescription className="text-slate-300">
                  Real-time visualization of global cybersecurity events
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                  {[
                    ...
                    },
                    {
                      ...
                      description: 'Increased phishing attempts mimicking popular social media platforms',
                      affected: '500+ attempts blocked',
                    ...
                    },
                    {
                      ...
                      description: 'Critical patches available for major operating systems',
                      affected: 'All systems',
                      action: 'Patch deployment scheduled'
                    },
                    {
                      time: '3 hours ago',
                      type: 'success',
                      title: 'Threat Neutralized',
                      description: 'Ransomware attack successfully contained and eliminated',
                      affected: '1 endpoint',
